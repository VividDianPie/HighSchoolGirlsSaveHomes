...
public class MonsterRun : BehaviorActionBase//切站立动画 调用状态 完成 结束 
{

    //构造函数
    public MonsterRun(EActionType type, ActionMachine am, GameObject master, ActionState pnt = null, ActionState cld = null)
