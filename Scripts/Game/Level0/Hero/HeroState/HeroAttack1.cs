...
public class HeroAttack1 : ActionState//角色攻击切动画 退出切idle 攻击判定
{
    bool whetherTheCombo;
    public HeroAttack1(EActionType type, ActionMachine am, GameObject master, ActionState pnt = null, ActionState cld = null)
    ...
    override public void Enter()
    {
        ...
        SoundMgr.Instance.PlayEffect("Music/EffectMusic/HeroAtk1");
    ...
    override public void OnAnimationHit(int i)
    {
        ...
        TimerMgr.Instance.OneShot("天殛之境_裁决CapsuleColliderInActivity", 0.6f, 天殛之境_裁决CapsuleColliderInActivity);
    }
    ...
    override public void Anima2stage()
    {
        ...
        {
            mAm.ChangeAction(EActionType.Attack2);
        }
    }
